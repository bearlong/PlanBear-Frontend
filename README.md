...
- 將真實附件替換為 Demo PDF
- 不連接任何正式企業資料庫、內部 API 或企業服務；前端仍透過 Demo Express API 取得 Mock Data。
...
| --- | --- |
| `NEXT_PUBLIC_API_URL` | Express Backend API URL，例如 `http://localhost:3005/api` |
| `NEXT_PUBLIC_BASE_URL` | Frontend URL |
| `NEXT_PUBLIC_USE_MOCK` | 啟用 Demo / Mock Mode |
| `NEXT_PUBLIC_VERSION` | 顯示的系統版本 |
| `NEXT_PUBLIC_ANALYTICS_ID` | Analytics 識別碼；未使用時可留空 |
